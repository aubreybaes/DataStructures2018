...
# this program allows you to sort, reverse, add/insert an item,get the size and count the palindrome in a given list of string.
# i've used the function of stack [LIFO] in reversing, adding and counting the palindrome
